...
void Plot_E_vistrue() // /pnfs/dune/persistent/users/flynnguo/myFDntuples/myntuple_61454381_*.root
{
  ...
  TString FileIn = "/pnfs/dune/persistent/users/flynnguo/FDGeoEffinND/OutFDGeoEff_62311511_999.root";
  ...
  for (Int_t plot_num = 0; plot_num < plot_total_num; plot_num++)
  {
    ...
    hist_ND_E_vis_true[plot_num]->GetYaxis()->SetTitleOffset(1.5);
    ...
    ratio_Eff_cut[plot_num]->GetXaxis()->SetTitleOffset(1.0);
    ...
    ratio_Eff_cut[plot_num]->GetYaxis()->SetTitleOffset(1.5);
